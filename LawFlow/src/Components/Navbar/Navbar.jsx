...
function Navbar() {
    ...
    useEffect(() => {
        const authToken = localStorage.getItem("authToken"); // Change key if necessary
                    ...
                    {isAuthenticated ? (
                        <div className="relative">
                            <svg
                                ...
                                strokeWidth={1.75}
                                stroke="currentColor"
                                className="size-8 text-white ml-5 mt-[2px] cursor-pointer"
                            >
                            ...
                            {showDropdown && (
                                <div className="absolute right-0 mt-2 w-48 bg-gray-900 border border-gray-700 rounded-lg shadow-lg">
                                    ...
                                    <button 
                                        ...
                                        className="block text-left w-full px-4 py-2 text-white hover:bg-red-600"
                                    >
                                        Logout
                                    </button>
                                </div>
                        ...
                        <button 
                            ...
                            className="bg-blue-500 text-white px-4 py-2 rounded-lg ml-5 mt-[2px]"
                        >
                            Login
                        </button>
                    )}
