...
function SupremeCourt (){
    ...
    const formhandler = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:3000/supreme-court/case", {
                method: "POST",
                body : body,
                headers : {
...

            {
                ...
                <div>
                    <form id="myform" onSubmit={(e)=>{formhandler(e)}}>
                        <label for="diaryNumber" className="text-white">diaryNumber</label>
                        <input name="diaryNumber" placeholder="Type here..." className="text-white border-1 border-gray-800 rounded-lg p-2 w-[390px]"></input>


                        <label for="year" className="text-white">Year</label>
                        <input name="year" placeholder="Type here..." className="text-white border-1 border-gray-800 rounded-lg p-2 w-[390px]"></input>
