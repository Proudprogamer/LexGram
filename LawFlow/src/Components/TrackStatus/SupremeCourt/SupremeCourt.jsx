...
function SupremeCourt() {
  ...
  const formHandler = async (e, endpoint) => {
    ...
    try {
      const response = await fetch(`https://lexgram.onrender.com/supreme-court/${endpoint}`, {
        method: "POST",
        body: body,
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white p-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-center">Supreme Court Case Search</h1>
        ...
        {field === "Case Details" && (
          <div className="w-full bg-gray-900 rounded p-6 mb-6">
            <form onSubmit={(e) => formHandler(e, "case")}>
              <label className="block text-xl mb-2">Enter Diary Number</label>
              <input 
                name="diaryNumber" 
                ...
                required
              />
              <label className="block text-xl mb-2">Year</label>
              <input 
                name="year" 
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-black p-4 rounded">
                  <p className="text-gray-400">Diary Number</p>
                  <p className="font-medium">{caseDetails.diaryNumber || "N/A"}</p>
                </div>
                <div className="bg-black p-4 rounded">
